...
object SecretItem {
  implicit val secretItemReads: Reads[SecretItem] = (
    (__ \ "id").readNullable[Int] ~
      (__ \ "secretId").readNullable[Int] ~
      (__ \ "itemId").readNullable[Int] ~
      (__ \ "itemContent").readNullable[String]
    )(SecretItem.apply _)

  implicit lazy val secretItemWrites: Writes[SecretItem] = (
    (__ \ "id").write[Option[Int]] ~
      (__ \ "secretId").write[Option[Int]] ~
      (__ \ "itemId").write[Option[Int]] ~
      (__ \ "itemContent").write[Option[String]]
